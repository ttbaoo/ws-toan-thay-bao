...
-- - hồ sơ: fullname, date_of_birth, phone, avatar_url, class_name
...
-- Seed admin mặc định (chỉ dùng để khởi tạo thủ công)
-- Mật khẩu plain text: Admin@123
INSERT INTO `users` (`fullname`, `date_of_birth`, `phone`, `avatar_url`, `class_name`, `role`, `user_tier`, `password`)
SELECT 'Quản trị viên hệ thống', '1990-01-01', '0999999999', NULL, '12A1', 'admin', 'premium',
       '$2y$10$te.wJH3mUPD6uGcckEQnwOLNcfy2HRLAQgVn9faRU/iGuQ/P7GvRu'
WHERE NOT EXISTS (
  SELECT 1 FROM `users` WHERE `phone` = '0999999999'
);
